    ...
    public partial class ClassroomForm : Form
    {
        ...
        private void buttonAfisare_Click(object sender, EventArgs e)
        {
           ...
           for (int i = 0; i < dataGridView1.RowCount; i++)
            ...
            string result = student.execCount(avg_muz);
        ...
        private void dataGridView1_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    try
                    {
                        ...
                        else if (Convert.ToInt32(testare) == 1)
                        {
                            ...
                            textBoxNote.Text = student.totalGrades(NumeMaterie, id);
                        }
                    }
                    catch
                    {
            ...
            try
            {
                ...
                textBoxTotal.Text = student.totalAbsente(id);
                textBoxMotivate.Text = student.totalAbsenteMotivate(id);
                textBoxNemotivate.Text = student.totalAbsenteNemotivate(id);
            ...
            try
            {
                ...
                textBoxAbsMaterie.Text = student.totalAbsenteMaterie(id, NumeMaterie);
            }
            catch
            {
                ...
                if(MessageBox.Show("Salvați modificările?","Modificare",MessageBoxButtons.YesNo,MessageBoxIcon.Question)==DialogResult.Yes)
                    ...
                    try
                    {
                        ...
                        if (checkBoxTeza.Checked == true)
                            ...
                            tezaDeEditat = false;
                        if(student.updateNota(idDeEditat,notaDeEditat,dataDeEditat,tezaDeEditat))
                        {
            ...
            if (MessageBox.Show("Adăugați notă?", "Adăugare notă", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    if (checkBoxTeza.Checked == true)
                        ...
                        tezaDeEditat = false;
                    if (student.addNota(materieDeEditat, notaDeEditat, dataDeEditat, idElevDeEditat, tezaDeEditat))
                    {
        ...
        private void buttonAddAbsence_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Elev absent?", "Adăugare absență", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    {
                        if (student.addAbsenta(idElevDeEditat, materieDeEditat, dataDeEditat))
                        {
        ...
        private void dataGridView3_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (rPos == 3)
            {
                if (MessageBox.Show("Schimbare status?", "Motivare absențe", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    {
                        bool motiv = true;
                        if (student.updateAbsenta(idAbs, motiv))
                        {
        ...
        private void dataGridView2_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (rPos == 3)
            {
                try
                {
                    if (student.updateNota(idDeEditat, notaDeEditat, dataDeEditat, teza))
                    {
